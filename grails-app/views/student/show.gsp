            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="student.course.label" default="Course" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: studentInstance, field: "course")}</td>
