...
<%@ page import="housemaster.Student" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="course"><g:message code="student.course.label" default="Course" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: studentInstance, field: 'course', 'errors')}">
                                    <g:textField name="course" value="${studentInstance?.course}" />
                                </td>
                            </tr>
